...
public enum VaseThreeStateType {
    ...
    EMPTY_VASE(687, 290,  "Resources/EmptyVase.PNG", 5),
    VASE_READY_FOR_SEEDS(687, 290, "Resources/VaseReadyForSeeds.PNG", 5),
    VASE_HAS_SEEDS(687, 290, "Resources/VaseHasSeeds.png", 5),
    VASE_HAS_WATER(687, 290, "Resources/VaseHasWater.png", 5),
    VASE_IS_GROWING(687, 263, "Resources/VasePlantGrowing.png", 5),
    VASE_IS_COLLECTABLE(687, 219, "Resources/VaseIsCollectable.png", 5);
